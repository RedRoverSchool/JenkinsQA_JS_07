...
describe('mcProjectConfig', () => {   
    ...
    it('TC_03.07.011 | Configure new multiconfiguration project > Add description', function() {
    ...
    it('TC_03.07.011 | Configure new multiconfiguration project > Check box test ', function() {
